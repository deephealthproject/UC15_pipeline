...
def plot_training_results(history: dict, exp_name: str, plots_path: str):
    ...
    Args:
        ...
        exp_name: Experiment name to generate the ouput plots.

        plots_path: Path to the directory to store the generated plots.
    """
    os.makedirs(plots_path, exist_ok=True)  # Check output folder
